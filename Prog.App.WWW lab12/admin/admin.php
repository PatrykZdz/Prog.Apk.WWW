...
function EdytujProdukt($link)
{
  ...
  if(isset($_POST['zapiszProdukt']))
  {
    ...
    ilosc_dostepych_sztuk_w_magazynie = ?, status_dostepnosci = ?, kategoria = ?,
  ...
  <form method='post' action=''>
      ...
      <input type ='number' step='0.01' name='podatek_vat' value'" . htmlspecialchars($produkt['cena_netto'], ENT_QUOTES)."'required><br>
